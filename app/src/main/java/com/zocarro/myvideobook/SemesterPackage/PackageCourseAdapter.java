...
public class PackageCourseAdapter extends RecyclerView.Adapter {
    Context ctx;
    ArrayList<PackageCourse> subjectSemesterArrayList;

    public PackageCourseAdapter(Context ctx, ArrayList<PackageCourse> subjectSemesterArrayList) {
        this.ctx = ctx;
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View myview = LayoutInflater.from(ctx).inflate(R.layout.layout_package_course, null);
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
        final PackageCourse semesterModel = subjectSemesterArrayList.get(position);
        ...
        String previewUrl= Common.GetBaseImageURL() +"src/course/" + semesterModel.getCourse_bg();

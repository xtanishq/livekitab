...
import com.zocarro.myvideobook.VideoCourse.FullScreenMediaController;
...
public class PlayPreview extends AppCompatActivity
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        toolbar.setTitle("Preview video");
        ...
        youTubePlayerView.addFullScreenListener(new YouTubePlayerFullScreenListener()
        {
            ...
            {
                Intent in = new Intent(PlayPreview.this, VideoFullscreenActivity.class);

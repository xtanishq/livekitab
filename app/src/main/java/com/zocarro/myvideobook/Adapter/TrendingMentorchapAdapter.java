...
import com.zocarro.myvideobook.Dashboard.MentorActivity;
import com.zocarro.myvideobook.Model.MentorchapModel;
import com.zocarro.myvideobook.R;

import java.util.List;

public class TrendingMentorchapAdapter extends RecyclerView.Adapter<TrendingMentorchapAdapter.ViewHolder>
{
    private static final String TAG = "CategoriesAdapter";
    Context context;
    List<MentorchapModel> subCatArrayList;

    public TrendingMentorchapAdapter(Context context, List<MentorchapModel> subCatArrayList)
    {
    ...
    {
        View view = LayoutInflater.from(context).inflate(R.layout.layout_trending_mentor_subjects, null);
        return new ViewHolder(view);
    }
    @Override
    public void onBindViewHolder(@NonNull ViewHolder holder, int position)
    {
        MentorchapModel model = subCatArrayList.get(position);
        ...
        holder.catImage.setDefaultImageResId(R.drawable.videobook_logo);
        holder.catImage.setErrorImageResId(R.drawable.videobook_logo);

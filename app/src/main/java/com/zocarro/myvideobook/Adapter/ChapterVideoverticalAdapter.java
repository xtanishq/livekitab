...
public class ChapterVideoverticalAdapter extends RecyclerView.Adapter<ChapterVideoverticalAdapter.VideoCourseHolder>
{
    Context ctx;
    ...
    public ChapterVideoverticalAdapter(Context ctx, ArrayList<VideoViewModel> videoViewModelArrayList, String video_id, boolean isPurchased,OnDeleteCartListener onDeleteCartListener)
    {
        this.ctx = ctx;
    ...
    {
        View myview = LayoutInflater.from(ctx).inflate(R.layout.layout_video_rows,null);
